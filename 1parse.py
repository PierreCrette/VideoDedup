...
if len(sys.argv)<2:
	...
	print('-f60 fps: take 1 picture each n seconds. Default fps=1/60 ie 1 picture every 60 seconds.')
	...
	log('-f60 fps: take 1 picture each n seconds. Default fps=1/60 ie 1 picture every 60 seconds.', 0)
